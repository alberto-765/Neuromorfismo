...
namespace WebMedicina.BackEnd.Model.Migrations
{
    ...
    [Migration("20240119230241_QuitarColumnaUltimaEtapa")]
    partial class QuitarColumnaUltimaEtapa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebMedicina.BackEnd.Model.AspnetroleModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "771a8378-34a6-4136-879f-368279b0acac",
                            Name = "superAdmin",
                        ...
                        {
                            Id = "2",
                            ConcurrencyStamp = "0e286082-ef2a-4b5d-a247-a4d192f06d43",
                            Name = "admin",
                        ...
                        {
                            Id = "3",
                            ConcurrencyStamp = "2b5b024f-98f1-434d-8ca5-047b8f8d75be",
                            Name = "medico",
            ...
            modelBuilder.Entity("WebMedicina.BackEnd.Model.PacientesModel", b =>
                {
                    b.HasOne("WebMedicina.BackEnd.Model.EtapaLTModel", null)
                        .WithMany("PacienteUltimaEtapa")
                        .HasForeignKey("EtapaLTModelId");
