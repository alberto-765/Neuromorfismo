...
namespace WebMedicina.BackEnd.Model.Migrations
{
    ...
    [Migration("20240104204509_SeedEtapasLineaTemporal")]
    partial class SeedEtapasLineaTemporal
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebMedicina.BackEnd.Model.AspnetroleModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "d08cf85d-88c7-4694-980d-175f322ecbf8",
                            Name = "superAdmin",
                        ...
                        {
                            Id = "2",
                            ConcurrencyStamp = "9452eda7-3f4d-41de-8aae-d5f5e6a97643",
                            Name = "admin",
                        ...
                        {
                            Id = "3",
                            ConcurrencyStamp = "215ddcdf-ccce-409b-b6c9-d3ba875cbbde",
                            Name = "medico",
            ...
            modelBuilder.Entity("WebMedicina.BackEnd.Model.EpilepsiaModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdEpilepsia = 1,
                            FechaCreac = new DateTime(2024, 1, 4, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaUltMod = new DateTime(2024, 1, 4, 0, 0, 0, 0, DateTimeKind.Local),
                            Nombre = "Epilepsia1"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("WebMedicina.BackEnd.Model.PacientesModel", b =>
                {
                    ...
                    b.Property<int?>("UltimaEtapaId")
                        .HasColumnType("int");

                    b.HasKey("IdPaciente")
                        .HasName("PRIMARY");

                    b.HasIndex("UltimaEtapaId");
