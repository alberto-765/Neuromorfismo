...
namespace WebMedicina.BackEnd.Model.Migrations
{
    ...
    [Migration("20240103125604_CambiosNombres2")]
    partial class CambiosNombres2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebMedicina.BackEnd.Model.AspnetroleModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "7cd8eadc-bd00-4a08-bf00-5e53c80a55f3",
                            Name = "superAdmin",
                        ...
                        {
                            Id = "2",
                            ConcurrencyStamp = "27a602df-9efd-409c-9600-18eb21c48126",
                            Name = "admin",
                        ...
                        {
                            Id = "3",
                            ConcurrencyStamp = "c2d479bf-e6ce-42fb-9ecc-51d3c6308fa7",
                            Name = "medico",
            ...
            modelBuilder.Entity("WebMedicina.BackEnd.Model.DatosEvoluEtapasLTModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebMedicina.BackEnd.Model.DatosEvoluEtapasLTModel", b =>
                {
                    b.HasOne("WebMedicina.BackEnd.Model.EtapaLTModel", "EtapaLT")
                        .WithMany()
